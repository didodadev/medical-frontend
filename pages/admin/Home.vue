  ...
  <div class="home">
    ...
    <div class="row mt-5">
      <div
        ...
        :key="index"
      >
        <img :src="pathHandler(i)" width="100%" />

        <div class="red-cover">
          <i class="bi bi-trash" @click="!loading ? removeSlide(index) : null" />
        </div>
      </div>

      <div class="col-md-7 cover-wrapper mt-3">
        <UploadImage :setBase64="uploadSlide" />
      </div>
    </div>
...
import pathHandler from '../../ts/public-url'
